...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: "Rooms & ratios", href: "/rooms", icon: DoorOpen, built: false },
  { label: "Enrollment", href: "/enrollment", icon: CirclePlus, built: false },
  { label: "Attendance", href: "/attendance", icon: Check, built: false },
  { label: "Billing", href: "/billing", icon: CreditCard, built: false },
  { label: "Messages", href: "/messages", icon: MessageSquare, built: false },
  { label: "Compliance", href: "/compliance", icon: CircleCheck, built: false },
